...
** TODO Change Scan Path Menu
   What is needed?
   A text box for each index in the scan path.
   Perhaps a top down view of the network with nodes labelled?
** TODO Change Node Mass
** TODO Change Connection Matrix
** TODO Change EQ Position
** TODO Select Hammer Table
* DONE Rotate Viewer
  Easy.
* TODO Visualize Scan Path
